...
function MainContent() {
    return (
        <main className="container select-none px-5 pb-5 md:px-0 mt-5 grid gap-y-10 md:grid-cols-2 sm:grid-cols-1 lg:gap-x-20 md:gap-x-16 md:gap-y-8 lg:md:gap-y-8 sm:gap-y-10 min-h-[80vh] text-white">
            ...
            <Box backGround="bg-[#0e1421]" hasPadding = {true} title="Today / Week">
                <ToDayWeekWeatherBox />
            </Box>
